...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address, receiver="Walter Huacho", amount=10)
    block = blockchain.create_block(proof, previous_hash)
    response = {
        'message': '¡Enhorabuena, nuevo bloque minado!',
        'index': block['index'],
...
def connect_node():
    ...
    response = {
        'message': 'Todos los nodos han sido conectados. La Blockchain de WalterCoins contiene ahora los nodos siguientes: ',
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'Los nodos tenían diferentes cadenas, se ha reemplazado por la Blockchain más larga.',
